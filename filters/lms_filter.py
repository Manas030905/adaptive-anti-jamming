...
Basic adaptive filter implementation.
"""
...
class LMSFilter:
    ...
    The LMS algorithm is a gradient-based adaptive filter that minimizes
    the mean squared error (MSE) between desired and estimated output.
    """
    ...
    def __init__(self, filter_order=64, mu=0.01, eps=1e-8):
        ...
        Args:
            ...
            mu (float): Step-size parameter (learning rate), typically 0.001-0.05
    ...
    def update(self, reference_signal, desired_signal):
        """
        Adapt filter weights using reference signal and desired output.
        ...
        for n in range(n_samples):
            ...
            # Store history every 100 samples for efficiency
            if n % 100 == 0:
